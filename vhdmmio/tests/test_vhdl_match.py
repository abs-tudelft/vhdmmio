...
class TestVhdlMatch(TestCase):
    ...
    def test_empty(self):
        self.assertEqual(match_template(32, []), '')

    def test_if(self):
        self.assertEqual(match_template(32, [(8, 3)]), '\n'.join([
        ...
        self.assertEqual(match_template(32, [(8, 3)], optimize=True), '\n'.join([
            '-- $address$ = 000000000000000000000000000010--',
            '$ADDR_0x8',
        ]))

    def test_if_else(self):
        self.assertEqual(match_template(32, [(4, 3), (0, 3)]), '\n'.join([
        ...
        self.assertEqual(match_template(32, [(4, 3), (0, 3)], optimize=True), '\n'.join([
            'if $address$(2) = \'0\' then',
            '  -- $address$ = 000000000000000000000000000000--',
            '$ ADDR_0x0',
            'else',
    ...
    def test_if_elsif(self):
        self.assertEqual(match_template(32, [(8, 7), (4, 3), (0, 3)], optimize=True), '\n'.join([
            'if $address$(3) = \'1\' then',
        ...
        self.assertEqual(match_template(32, [(12, 3), (8, 3), (0, 7)], optimize=True), '\n'.join([
            'if $address$(3) = \'0\' then',
    ...
    def test_case_statement(self):
        self.assertEqual(match_template(32, [(8, 3), (4, 3)]), '\n'.join([
        ...
        self.assertEqual(match_template(32, [(8, 3), (4, 3)], optimize=True), '\n'.join([
            'case $address$(3 downto 2) is',
            '  when "01" =>',
            '    -- $address$ = 000000000000000000000000000001--',
            '$   ADDR_0x4',
    ...
    def test_common_suffix(self):
        self.assertEqual(match_template(32, [16, 32]), '\n'.join([
        ...
        self.assertEqual(match_template(32, [16, 32], optimize=True), '\n'.join([
            'case $address$(5 downto 4) is',
            '  when "01" =>',
            '    -- $address$ = 00000000000000000000000000010000',
            '$   ADDR_0x10',
